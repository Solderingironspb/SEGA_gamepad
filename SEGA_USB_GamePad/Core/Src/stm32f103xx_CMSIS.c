...
void CMSIS_SPI1_init(void) {
	...
	MODIFY_REG(GPIOA->CRL, GPIO_CRL_CNF6, 0b10 << GPIO_CRL_CNF6_Pos); //Input pull-up
	...
	MODIFY_REG(SPI1->CR1, SPI_CR1_BR, 0b011 << SPI_CR1_BR_Pos); //fPCLK/16. 72000000/16 = 4.5 MBits/s
